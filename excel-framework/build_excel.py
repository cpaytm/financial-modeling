...
html-framework/template.html에서 "📥 JSON" 버튼으로 내보낸 IR JSON을 입력으로,
...
예:
    python excel-framework/build_excel.py financial_model_2026-05-25.json -o my_model.xlsx
"""
...
def build_workbook(data: dict, out_path: Path) -> None:
    ...
    ws3.cell(row=1, column=2, value="financial-modeling/excel-framework/build_excel.py")
